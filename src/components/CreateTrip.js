...
class CreateTrip extends Component {
  ...
  async insertDataUser(myid, idTrip, country){
    let dbCon = firebase.database().ref('Users/'+ myid).child(idTrip);
      dbCon.set({
        country: country,
      });
  }
  async insertDataTrip(){
    if(this.notNullCheck()){
      ...
      let dbCon = firebase.database().ref('/Trips').child(country)
            ...
            <div className="container" style={{marginTop: "30px"}}>
              <Form>
                ...
                <Form.Group>
                  ...
                  <Form.Control id="country" as="select">
                 ...
                 <Form.Group >
                  ...
                  <Form.Control id="duration" as="select">
                    <option >1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
